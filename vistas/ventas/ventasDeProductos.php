	...
	<div class="col-sm-4">
		<form id="frmVentasProductos">
			...
			<select class="form-control input-sm" id="clienteVenta" name="clienteVenta">
				...
				<?php
				$sql="SELECT id_pedido, nombreCliente, apellidoCliente 
				FROM pedidos";
		...
		$('#productoVenta').change(function(){
			$.ajax({
				...
				success:function(r){
					...
					$('#imgProducto').prepend('<img class="img-thumbnail" id="imgp" src="' + dato['ubicacion'] + '" />');
				}
			});
		});
		...
		$.ajax({
			...
			success:function(r){
				if(r > 0){
					...
					alertify.alert("Venta creada con éxito, consulte la información de esta en Ventas hechas");
				}else if(r==0){
